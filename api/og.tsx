    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '40px' }}>
          ...
          <span style={{ color: '#64748b', fontSize: '18px', fontWeight: 600, letterSpacing: '0.05em' }}>
            thestormwatcher.com
          </span>
        </div>
        ...
        {/* Subtitle */}
        <div style={{ fontSize: '28px', color: '#94a3b8', marginBottom: '40px', maxWidth: '800px' }}>
          {meta.subtitle}
        </div>
        ...
        {showKp && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            >
              <span style={{ color: '#94a3b8', fontSize: '16px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                Kp index
              </span>
              <span style={{ color, fontSize: '36px', fontWeight: 800 }}>{kp.toFixed(1)}</span>
              {gLevel && (
                <span
                  style={{
                    background: `${color}33`,
            ...
            <span style={{ color: '#334155', fontSize: '16px' }}>Live · Updated every 3h</span>
          </div>
        )}
      </div>
    ),

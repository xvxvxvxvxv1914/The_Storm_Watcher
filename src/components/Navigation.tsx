          ...
          <div className="hidden lg:flex items-center flex-1 min-w-0 ml-3 xl:ml-5 gap-2 xl:gap-3">
            <div className="flex items-center gap-1 xl:gap-2">
              ...
              <div className="relative" ref={moreMenuRef}>
                ...
                {isMoreOpen && (
                  <div className="absolute left-0 mt-3 w-52 nav-dropdown rounded-xl shadow-2xl py-2 border border-[#f97316]/20">
                    {moreLinks.map((link) => (
                      <Link
                        key={link.to}
                        to={link.to}
            ...
            <div className="relative shrink-0" ref={langMenuRef}>
              ...
              {isLangMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 nav-dropdown rounded-xl shadow-2xl py-2 border border-[#f97316]/20">
                  {languages.map((lang) => (
                    <button
                      key={lang.code}
            ...
            {user ? (
              <div data-tour="user-menu" className="relative shrink-0" ref={userMenuRef}>
                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 nav-dropdown rounded-xl shadow-2xl py-2 border border-[#f97316]/20">
